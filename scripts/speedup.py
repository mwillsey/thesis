...
plot_times(filename='_build/speedup.pdf', log=False)
plot_times(filename='_build/speedup-log.pdf', log=True)
plot_iters(filename='_build/speedup-iter.pdf')
corr = plot_repairs(filename='_build/repairs.pdf')
...
with open("_build/speedup-data.tex", "w") as f:
    f.write(
